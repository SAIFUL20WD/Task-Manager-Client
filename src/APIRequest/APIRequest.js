...
const BaseURL = "https://task-manager-server-qgvx.onrender.com/api/v1";
...
export function UpdateStatusRequest(id, status) {
    ...
    // Must Pass the empty object becuase it POST request, it's need data
    return axios.post(URL, {}, AxiosHeader)
        ...
        .catch((err) => {
            ErrorToast("Something Went Wrong xx");
            store.dispatch(HideLoader());
            return false;
        });
}
